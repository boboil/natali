    ...
    @if($sliders)
            <div class="home-slider owl-carousel owl-theme show-nav-hover nav-big">
                ...
                <div class="home-slide home-slide1 banner">
                    <img class="slide-bg owl-lazy" src="{{ asset('/theme/images/lazy.png') }}" data-src="{{Voyager::image($slider->thumbnail('big_image'))}}" alt="home banner">
                    <div class="banner-layer banner-layer-middle">
                        {!! $slider->slider_text !!}
                        <a href="{{$slider->link}}" class="btn btn-dark btn-xl" role="button">{{ $slider->btn_text }}</a>
                    </div><!-- End .banner-layer -->
                </div><!-- End .home-slide -->
                @endforeach

                <div class="home-slide home-slide2 banner">
                    <img class="slide-bg owl-lazy" src="{{ asset('/theme/images/lazy.png') }}" data-src="{{ asset('/theme/images/slider/slide2.jpg') }}" alt="home banner">
                    <div class="banner-layer banner-layer-middle">
