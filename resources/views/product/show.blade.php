                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme">
                                    ...
                                    @if($product->gallery)
                                        ...
                                        @foreach($images as $image)
                                            <div class="product-item">
                                                <img class="product-single-image" src="{{ Voyager::image($product->getThumbnail($image, 'big_image')) }}" data-zoom-image="{{ Voyager::image($product->getThumbnail($image, 'big_image')) }}" />
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
                            ...
                            @if($product->gallery)
                                <div class="prod-thumbnail owl-dots" id='carousel-custom-dots'>
                                    <div class="owl-dot">
                                        <img src="{{Voyager::image($product->thumbnail('product'))}}"/>
                                    </div>
                                    @foreach($images as $image)
                                        <div class="owl-dot">
                                            <img src="{{ Voyager::image($product->getThumbnail($image, 'min_image')) }}"/>
                                        </div>
                                    @endforeach
                                </div>
                            @endif
                        ...
                        <div class="col-lg-5 col-md-6 product-single-details">
                            ...
                            <ul class="single-info-list">
                                <li>Производитель: <strong>{{ $manufacturer->title }}</strong></li>
                            ...
                            <div class="product-filters-container">
                                <div class="product-single-filter">
                                    <label>ОБЪЁМ:</label>
                                    @php
                                        $selects = json_decode($product->options);
                                    @endphp
                                    <select id="service-select" class="select-custom">
                                        <option data-content="0" value="0" selected> --- Выберите --- </option>
                                        @foreach($selects as $select)
                                            <option data-content="{{ $select->key }}" value="{{ $loop->iteration }}">{{ $select->key }} {{ $select->value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="product-action">
                                ...
                                <a data-content="{{$product->id}}" href="cart.html" class="btn btn-dark add-cart" title="Add to Cart">Add to Cart</a>
                ...
                <div class="product-single-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="product-tab-more-info" data-toggle="tab" href="#product-more-info-content" role="tab" aria-controls="product-more-info-content" aria-selected="false">Характеристики</a>
                            </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade fade" id="product-more-info-content" role="tabpanel" aria-labelledby="product-tab-more-info">
                            <div class="product-desc-content">
                                <dl class="row">
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Класс косметики</dt>
                                    <dd class="col-sm-10">{{ $product->cosmetics_class }}</dd>
                                @endif
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Назначение</dt>
                                    <dd class="col-sm-10">{{ $product->appointment }}</dd>
                                @endif
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Применение</dt>
                                    <dd class="col-sm-10">{{ $product->application }}</dd>
                                @endif
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Состав</dt>
                                    <dd class="col-sm-10">{{ $product->structure }}</dd>
                                @endif
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Тип кожи</dt>
                                    <dd class="col-sm-10">{{ $product->skin_type }}</dd>
                                @endif
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Возраст</dt>
                                    <dd class="col-sm-10">{{ $product->age }}</dd>
                                @endif
                                @if($product->cosmetics_class)
                                    <dt class="col-sm-2">Вид товара</dt>
                                    <dd class="col-sm-10">{{ $product->type_products }}</dd>
                                @endif
                            </dl>
                            </div><!-- End .product-desc-content -->
                        </div><!-- End .tab-pane -->
        ...
        <div class="container">
            ...
            <div class="products-slider owl-carousel owl-theme dots-top">
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('/theme/images/products/product-1.jpg') }}">
                        </a>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('/theme/images/products/product-2.jpg') }}">
                        </a>
                        <div class="btn-icon-group">
                            <button class="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i class="icon-shopping-cart"></i></button>
                        </div>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('/theme/images/products/product-3.jpg') }}">
                        </a>
                        <div class="btn-icon-group">
                            <button class="btn-icon btn-add-cart" data-toggle="modal" data-target="#addCartModal"><i class="icon-shopping-cart"></i></button>
                        </div>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('/theme/images/products/product-4.jpg') }}">
                        </a>
                        <div class="label-group">
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('/theme/images/products/product-5.jpg') }}">
                        </a>
                        <div class="label-group">
                            <span class="product-label label-hot">HOT</span>
                        </div>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure>
                        <a href="product.html">
                            <img src="{{ asset('/theme/images/products/product-6.jpg') }}">
                        </a>
                        <div class="label-group">
